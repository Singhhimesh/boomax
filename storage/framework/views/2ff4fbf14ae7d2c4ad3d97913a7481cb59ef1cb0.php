...
<head>
    ...
    <link href="<?php echo e(url('fonts/flaticon/font/flaticon.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- flaticon css -->
    ...
    <link href="<?php echo e(url('css/pe-icon-7-stroke.css')); ?>" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <div class="loading">
            <div class="logo">
                <?php if($configs->preloader_img != null): ?>
                    <img src="<?php echo e(url('images/' . $configs->preloader_img)); ?>" class="img-responsive"
                        alt="<?php echo e($w_title); ?>">
                <?php else: ?>
                    <img src="<?php echo e(url('images/logo/' . $configs->logo)); ?>" class="img-responsive"
                        alt="<?php echo e($w_title); ?>">
                <?php endif; ?>
            </div>
    ...
    <?php
        ...
        $custom_page = App\CustomPage::where('in_show_menu', '1')
            ->where('is_active', '1')
            ->get();
                    ...
                    <div class="nav-logo">
                        <div class="nav-logo">
                            <?php if($catlog == 0 && $configs->remove_landing_page == 1): ?>
                                <a href="#" title="<?php echo e($w_title); ?>"><img
                                        src="<?php echo e(url('images/logo/' . $logo)); ?>" class="img-responsive"
                                        alt="<?php echo e($w_title); ?>"></a>
                            <?php else: ?>
                                <a href="<?php echo e(url('/')); ?>" title="<?php echo e($w_title); ?>"><img
                                        src="<?php echo e(url('images/logo/' . $logo)); ?>" class="img-responsive"
                                        alt="<?php echo e($w_title); ?>"></a>
                            <?php endif; ?>
                        </div>
                                ...
                                <?php if(Auth::user()->kids_mode_active == 0): ?>
                                    <?php if(isset($menuh) && count($menuh) > 0): ?>
                                        <?php $__currentLoopData = $menuh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
                                                <li>
                                                    <a class="<?php echo e(Nav::hasSegment($menus->slug)); ?>"
                                                        href="<?php echo e(url('/', $menus->slug)); ?>"
                                            ...
                                            <?php else: ?>
                                                <li>
                                                    <a class="<?php echo e(Nav::hasSegment($menus->slug)); ?>"
                                                        href="<?php echo e(url('/guest', $menus->slug)); ?>"
                                                        title="<?php echo e($menus->name); ?>">
                                                        <?php echo e($menus->name); ?>
                                    ...
                                    <?php if(isset($custom_page) && count($custom_page) > 0): ?>
                                        <?php $__currentLoopData = $custom_page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(isset($custom)): ?>
                                                <li>
                                                    <a class="<?php echo e(Nav::hasSegment($custom->slug)); ?>"
                                                        href="<?php echo e(url('/page', $custom->slug)); ?>"
                    ...
                    <div class="login-panel-main-block small-screen-block">
                        <ul>
                                    ...
                                    <?php if($catlog == 0 && getSubscription()->getData()->subscribed == true): ?>
                                        <li class="prime-search-block">
                                            <form class="searchbar" action="<?php echo e(route('search')); ?>">
                                                <input type="text" id="searchbar" class="btn-extended"
                                                    placeholder="<?php echo e(__('Search')); ?>" name="search" />
                                                <label for="search-box" class="btn-search"><i
                                                        class="flaticon-search"></i></label>
                                            </form>
                                        </li>
                                    <?php elseif($catlog == 1): ?>
                                        <li class="prime-search-block">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->kids_mode_active == 1): ?>
                                    <li class="kids-btn">
                                        <a type="button" href="<?php echo e(route('get.kids', Auth::user()->id)); ?>"
                                            class="btn btn-primary">Exit Kids</a>
                                    </li>
                                <?php else: ?>
                                    <?php if(getSubscription()->getData()->subscribed == true): ?>
                                        <li>
                                            <div id="ex4" class="dropdown prime-dropdown">
                                                ...
                                                <button class="btn btn-primary dropdown-toggle notification-dropdown"
                                                    ...
                                                    <div class="notify-count count" count="0">
                                                        <div class="value">
                                                            <?php echo e(auth()->user()->unreadnotifications->count()); ?></div>
                                                    </div>
                                                </button>
                                                    ...
                                                    <?php $__currentLoopData = auth()->user()->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            ...
                                                            <div id="notification_id"
                                                                onclick="readed('<?php echo e($n->id); ?>')"
                                                                class="card notification-id">
                                                                <p class="notification-title"><b> <?php echo e($n->title); ?></b>
                                                                </p>
                                                                <p class="notification-data"> <?php echo e($n->data['data']); ?>
                                                                    ...
                                                                    <?php if(isset($tv)): ?>
                                                                        <a type="button"
                                                                            href="<?php echo e(url('show/detail', $season->season_slug)); ?>"
                                                                    ...
                                                                    <?php if(isset($moviename)): ?>
                                                                        <a type="button"
                                                                            href="<?php echo e(url('movie/detail', $movieslug)); ?>"
                                                                            class="notification-button">
                                            ...
                                            <li class="sign-in-block language-switch-block">
                                                <div class="dropdown prime-dropdown">
                                                    <button class="btn btn-primary dropdown-toggle" type="button"
                                                        data-toggle="dropdown"><i class="flaticon-translate"></i>
                                                            ...
                                                            <ul>
                                                                <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li>
                                                                        ...
                                                                        <a
                                                                            href="<?php echo e(route('languageSwitch', $langitem->local)); ?>">
                                                        ...
                                                        <ul>
                                                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    ...
                                                                    <a
                                                                        href="<?php echo e(route('currencySwitch', $currency->code)); ?>">
                                    ...
                                    <li class="sign-in-block admin-dropdown">
                                        <div class="dropdown prime-dropdown">
                                            <button class="btn btn-primary dropdown-toggle" type="button"
                                                id="dropdownMenuButton1" data-toggle="dropdown"><i
                                                    class="fa fa-user-circle"></i>
                                                <?php if(Session::has('nickname')): ?>
                                                    <?php echo e(Session::get('nickname')); ?>

                                                <?php else: ?>
                                                    <?php echo e($auth ? $auth->name : ''); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-7 col-md-6 col-sm-6">
                                                                <div class="admin-wallet-block">
                                                                    <ul>
                                                                        <li><img src="<?php echo e(url('/images/walletnew.png')); ?>"
                                                                                class="img-fluid" alt="">
                                                                            <span
                                                                                class="wallet-title"><?php echo e(__('Wallet Balance')); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span>
                                                            ...
                                                            <div class="col-lg-5 col-md-6 col-sm-6">
                                                                <div class="admin-money-block text-right">
                                                                    <a href="<?php echo e(route('user.wallet.show')); ?>">
                                                                        <ul>
                                                                            <li><img src="<?php echo e(url('/images/money.png')); ?>"
                                                    ...
                                                    <div class="scroll-down">
                                                        <ul class="admin-list">
                                                            <?php if($auth->is_admin == 1): ?>
                                                                <li><a href="<?php echo e(url('admin')); ?>" target="_blank"><img
                                                                            src="<?php echo e(url('images/user_dropdown/globe.png')); ?>"
                                                                            class="img-fluid"
                                                                            alt=""><?php echo e(auth()->user()->getRoleNames()[0]); ?>

                                                                        <?php echo e(__('Dashboard')); ?></a></li>
                                                            <?php endif; ?>
                                                            <?php if($auth->is_assistant == 1): ?>
                                                                <li>
                                                                    <a href="<?php echo e(url('admin')); ?>" target="_blank"><img
                                                                            src="<?php echo e(url('images/user_dropdown/globe.png')); ?>"
                                                                            class="img-fluid" alt="">
                                                                        <?php echo e(__('Producer Dashboard')); ?></a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <li><a href="<?php echo e(url('account')); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/pie-chart.png')); ?>"
                                                                        class="img-fluid"
                                                                        alt=""><?php echo e(__('Dashboard')); ?></a></li>
                                                            <?php if(Module::find('Producer') && Module::find('Producer')->isEnabled()): ?>
                                                                <?php if($auth->is_admin != 1): ?>
                                                                    <?php if($button->producer_approval == 1 && $auth->producer_status == 0): ?>
                                                                        <li><a href="" data-toggle="modal"
                                                                                data-target="#myModalproducer"><?php echo e(__('Become An Producer')); ?></a>
                                                                        </li>
                                                                    <?php else: ?>
                                                                        <li><a
                                                                                href="<?php echo e(url('producer/subscription')); ?>"><?php echo e(__('Producer Subscription Plans')); ?></a>
                                                                        </li>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                            <?php if(getSubscription()->getData()->subscribed == true): ?>
                                                                <li><a href="<?php echo e(route('protectedvideo')); ?>"><img
                                                                            src="<?php echo e(url('images/user_dropdown/shield.png')); ?>"
                                                                            class="img-fluid"
                                                                            alt=""><?php echo e(__('Protected Content')); ?></a>
                                                                </li>
                                                            <?php else: ?>
                                                                <li><a
                                                                        href="<?php echo e(url('account/purchaseplan')); ?>"><?php echo e(__('Subscribe')); ?></a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php if(Module::find('Ebook') && Module::find('Ebook')->isEnabled()): ?>
                                                                <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
                                                                    <li><a href="<?php echo e(url('account/ebook')); ?>"><img
                                                                                src="<?php echo e(url('images/user_dropdown/blog.png')); ?>"
                                                                                class="img-fluid"
                                                                                alt=""><?php echo e(__('Ebooks')); ?></a>
                                                                    </li>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                            <?php if(isset($button) && $button->movie_request == 1): ?>
                                                                <li><a href="" data-toggle="modal"
                                                                        data-target="#myModalmovierequest"><?php echo e(__('Request a Movie')); ?></a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php if($auth && getSubscription()->getData()->subscribed == true && $configs->blog == 1): ?>
                                                                <li><a href="<?php echo e(url('account/blog')); ?>"><img
                                                                            src="<?php echo e(url('images/user_dropdown/blog.png')); ?>"
                                                                            class="img-fluid"
                                                                            alt=""><?php echo e(__('Blog')); ?></a></li>
                                                            <?php endif; ?>
                                                            <li><a href="<?php echo e(url('faq')); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/help.png')); ?>"
                                                                        class="img-fluid"
                                                                        alt=""><?php echo e(__('Faq')); ?></a></li>
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                      <ul> -->
                                                            ...
                                                            <?php if($auth && getSubscription()->getData()->subscribed == true && $mlt_screen == 1): ?>
                                                                <li><a
                                                                        href="<?php echo e(url('/manageprofile/mus/' . Auth::user()->id)); ?>"><img
                                                                            src="<?php echo e(url('images/user_dropdown/user-profile.png')); ?>"
                                                                            class="img-fluid"
                                                                            alt=""><?php echo e(__('Manage Profile')); ?></a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php
                                                            ...
                                                            <?php if(!is_null($donation) && !is_null($donation_link) && $donation == 1): ?>
                                                                <li><a target="_blank" href="<?php echo e($donation_link); ?>"><img
                                                                            src="<?php echo e(url('images/user_dropdown/donation.png')); ?>"
                                                                            class="img-fluid"
                                                                            alt=""><?php echo e(__('Donation')); ?></a></li>
                                                            <?php endif; ?>

                                                            <?php if(isset($button) && $button->two_factor == 1): ?>
                                                                <li><a
                                                                        href="<?php echo e(route('2fa.get')); ?>"><?php echo e(__('2Factor Authentication')); ?></a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php
                                                                $nav = App\Menu::orderBy('position', 'ASC')->get();
                                                            ?>
                                                            <li><a href="<?php echo e(route('watchhistory')); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/history.png')); ?>"
                                                                        class="img-fluid"
                                                                        alt=""><?php echo e(__('Watch History')); ?> </a>
                                                            </li>
                                                            <li><a href="<?php echo e(route('hidden.videos')); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/hide.png')); ?>"
                                                                        class="img-fluid"
                                                                        alt=""><?php echo e(__('Hidden Videos')); ?> </a>
                                                            </li>
                                                            <li><a href="<?php echo e(url('account/watchlist', $nav[0]->slug)); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/bookmark.png')); ?>"
                                                                        class="img-fluid"
                                                                        alt=""><?php echo e(__('Watch list')); ?> </a> </li>
                                                            <li>
                                                                <a href="<?php echo e(route('custom.logout')); ?>"><img
                                                                        src="<?php echo e(url('images/user_dropdown/log-out.png')); ?>"
                                                                        class="img-fluid" alt="">
...
<?php else: ?>
    ...
    <div>
        ...
        <div class="modal fade" data-backdrop="" id="myModalproducer" tabindex="-1" role="dialog"
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(Auth::user()->producer == 0): ?>
                            ...
                            <div class="modal-body">
                                <form id="demo-form2" method="POST" action="<?php echo e(url('request-producer')); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fname"><?php echo e(__('User Name')); ?> : <sup
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email"><?php echo e(__('Email')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="email" class="form-control" name="email" id="title"
                                                    placeholder="<?php echo e('Enter Email'); ?>" value="<?php echo e($auth->email); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="number"><?php echo e(__('Age')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="number" value="<?php echo e($auth->age); ?>" class="form-control"
                                                    name="age" id="title" placeholder="<?php echo e('Enter Age'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="contact"><?php echo e(__('Mobile')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="number" class="form-control" name="mobile" id="contact"
                                                    placeholder="<?php echo e(__('Enter Mobile No')); ?>"
                                                    value="<?php echo e($auth->mobile); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="file"><?php echo e(__('Upload Your ID Proof')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="file" class="form-control" name="govtid" id="file"
                                                    value="<?php echo e($auth->govtid); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="file"><?php echo e(__('Upload Your Image')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="file" class="form-control" name="image" id="file"
                                                    value="<?php echo e($auth->image); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="textarea"><?php echo e(__('Description')); ?> : <sup
                                                        class="redstar">*</sup></label>
                                    ...
                                    <div class="box-footer">
                                        <button type="submit"
                                            class="btn btn-lg col-md-3 btn-primary"><?php echo e(__('Submit')); ?></button>
                                    </div>
                                </form>
                            </div>
                        <?php else: ?>
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">
                                    <?php echo e(__('You Already sent a request for Producer')); ?></h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <form id="demo-form2" method="POST" action="<?php echo e(url('cancel-request-producer')); ?>"
                                    data-parsley-validate class="form-horizontal form-label-left"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="box-footer">
                                        <button type="submit"
                                            class="btn btn-lg col-md-3 btn-danger"><?php echo e(__('Cancel Request')); ?></button>
                                    </div>
                                </form>
                            </div>
                        <?php endif; ?>
        ...
        <!--MOVIE REQUEST FORM-->
        <div class="modal fade" data-backdrop="" id="myModalmovierequest" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="modal-body">
                            <form id="demo-form2" method="POST" action="<?php echo e(url('request-movie')); ?>"
                                data-parsley-validate class="form-horizontal form-label-left"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="id" value="<?php echo e($auth->id); ?>" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname"><?php echo e(__('Movie Request Name')); ?> : <sup
                                                class="redstar">*</sup></label>
                                        <input type="text" class="form-control" name="mr_name" id="title"
                                            placeholder="  <?php echo e(__('Enter Your Requet Movie Name')); ?>" required>
                                    </div>
                                </div>
                        </div>
        ...
        <nav class="sidenav" id="mySidenav" role="navigation">
            ...
            <ul class="nav sidebar-nav">
                                ...
                                <?php if(isset($menuh) && count($menuh) > 0): ?>
                                    <?php $__currentLoopData = $menuh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
                                            <li>
                                                <a class="<?php echo e(Nav::hasSegment($menus->slug)); ?>"
                                                    href="<?php echo e(url('/', $menus->slug)); ?>" title="<?php echo e($menus->name); ?>">
                                                    <?php echo e($menus->name); ?>
                                ...
                                <?php if(isset($custom_page) && count($custom_page) > 0): ?>
                                    ...
                                    <?php if($button->kids_mode == 1): ?>
                                        <?php if(Auth::user() && $auth != null && getSubscription()->getData()->subscribed == true): ?>
                                            <li style="width:13%;padding: 0px">
                                                <a href="<?php echo e(route('get.kids', Auth::user()->id)); ?>"
                                                    style="background-image: url(<?php echo e(asset('images/kids.png')); ?>);background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php else: ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(getSubscription()->getData()->subscribed == true): ?>
                            <li>
                                <div id="ex4" class="dropdown prime-dropdown">
                                    ...
                                    <span class="p1 fa-stack fa-2x has-badge dropdown-toggle" type="button"
                                        data-toggle="dropdown"
                                        data-count="<?php echo e(auth()->user()->unreadnotifications->count()); ?>">

                                        <i class="p3 flaticon-bell fa-stack-1x xfa-inverse"
                                            data-count="4b"><?php echo e(__('Notification')); ?></i>
                                        <div class="notify-count count" count="0">
                                    ...
                                    <ul class="dropdown-menu prime-dropdown-menu">
                                        ...
                                        <?php $__currentLoopData = auth()->user()->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                ...
                                                ?>
                                                <div id="notification_id" onclick="readed('<?php echo e($n->id); ?>')"
                                                    class="card notification-id">
                                ...
                                <ul class="dropdown-menu prime-dropdown-menu">
                                    <?php if($auth->is_admin == 1): ?>
                                        <li><a href="<?php echo e(url('admin')); ?>"
                                                target="_blank"><?php echo e(__('Admin Dashboard')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if($auth->is_assistant == 1): ?>
                                        <li>
                                    ...
                                    <?php if(getSubscription()->getData()->subscribed == true): ?>
                                        <li><a href="<?php echo e(route('protectedvideo')); ?>"><?php echo e(__('Protected Content')); ?></a>
                                        </li>
                                    <?php else: ?>
                                        <li><a href="<?php echo e(url('account/purchaseplan')); ?>"><?php echo e(__('Subscribe')); ?></a></li>
                                    <?php endif; ?>
                                    ...
                                    ?>
                                    <?php if(!is_null($donation) && !is_null($donation_link) && $donation == 1): ?>
                                        <li><a target="_blank" href="<?php echo e($donation_link); ?>"><?php echo e(__('Donation')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <li><a href="<?php echo e(url('faq')); ?>"><?php echo e(__('FAQa')); ?></a></li>
                                    <?php if(isset($button) && $button->two_factor == 1): ?>
                                        <li><a href="<?php echo e(route('2fa.get')); ?>"><?php echo e(__('2Factor Authentication')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php
                                        $nav = App\Menu::orderBy('position', 'ASC')->get();
                                    ...
                                    <li><a href="<?php echo e(url('account/watchlist', $nav[0]->slug)); ?>"> <?php echo e(__('Watch list')); ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <li class="sign-in-block sign-in-block-one sign-in-block-two"><a class="sign-in"
                            href="<?php echo e(url('login')); ?>"><i class="flaticon-login"></i> <?php echo e(__('Sign-in')); ?></a></li>
                    <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="<?php echo e(url('register')); ?>"><i
                                class="flaticon-profile"></i><?php echo e(__('Register')); ?></a></li>
                <?php endif; ?>
    ...
    <?php if($prime_footer == 1): ?>
        <footer id="prime-footer" class="prime-footer-main-block">
            <div class="container-fluid">
                ...
                <div class="logo">
                    <img src="<?php echo e(url('images/logo/' . $logo)); ?>" class="img-responsive"
                        alt="<?php echo e($w_title); ?>">
                </div>
                ...
                <div class="text-center">
                    ...
                    <div class="footer-widgets social-widgets social-btns">
                        <ul>
                            <?php if(isset($si->url1)): ?>
                                <li><a href="<?php echo e($si->url1); ?>" target="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                </li>
                            <?php endif; ?>
                            <?php if(isset($si->url2)): ?>
                                <li><a href="<?php echo e($si->url2); ?>" target="_blank"><i class="fa fa-twitter"></i></a>
                                </li>
                            <?php endif; ?>
                            <?php if(isset($si->url3)): ?>
                                <li><a href="<?php echo e($si->url3); ?>" target="_blank"><i class="fa fa-youtube"></i></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <div class="footer-widgets social-widgets social-btns">
                        <ul>
                            <?php if($isappstore == 1 && $isappstore != null): ?>
                                <li> <a href="<?php echo e($appstore); ?>" target="_blank"> <img width="12%"
                                            height="12%" src="<?php echo e(url('images/app_store_download.png')); ?>"></a>
                                </li>
                            <?php endif; ?>
                            <?php if($isplay == 1 && $isplay != null): ?>
                                <li>
                                    <a href="<?php echo e($playstore); ?>" target="_blank"> <img width="12%"
                                            height="12%" src="<?php echo e(url('images/google_play_download.png')); ?>"></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="footer-links-block">
                                            ...
                                            <ul>
                                                ...
                                                <?php if(isset($configs->terms_condition) && $configs->terms_condition != null): ?>
                                                    <li><a
                                                            href="<?php echo e(url('terms_condition')); ?>"><?php echo e(__('Terms and Condition')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if(isset($configs->privacy_pol) && $configs->privacy_pol != null): ?>
                                                    <li><a
                                                            href="<?php echo e(url('privacy_policy')); ?>"><?php echo e(__('Privacy Policy')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if(isset($configs->refund_pol) && $configs->refund_pol != null): ?>
                                                    <li><a
                                                            href="<?php echo e(url('refund_policy')); ?>"><?php echo e(__('Refund Policy')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                                <li><a href="<?php echo e(url('faq')); ?>"><?php echo e(__('Help')); ?></a></li>
                                                <li><a href="<?php echo e(url('contactus')); ?>"><?php echo e(__('Contact Us')); ?></a>
                                                </li>
                                                ...
                                                <?php if(isset($menuh)): ?>
                                                    <?php $__currentLoopData = $menuh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value->slug != null || $value->slug != ''): ?>
                                                            ...
                                                            <li><a
                                                                    href="<?php echo e(url($mySlug)); ?>"><?php echo e($value->name); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="footer-widgets social-widgets social-btns">
                                <ul>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($si->url2)): ?>
                                        <li><a href="<?php echo e($si->url2); ?>" target="_blank"><i
                                                    class="fa fa-twitter"></i></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if(isset($si->url3)): ?>
                                        <li><a href="<?php echo e($si->url3); ?>" target="_blank"><i
                                    ...
                                    <?php if($isappstore == 1 && $isappstore != null): ?>
                                        <li> <a href="<?php echo e($appstore); ?>" target="_blank"> <img width="72%"
                                                    height="72%"
                                                    src="<?php echo e(url('images/app_store_download.png')); ?>"></a></li>
                                    <?php endif; ?>
                                    <?php if($isplay == 1 && $isplay != null): ?>
                                        <li>
                                            <a href="<?php echo e($playstore); ?>" target="_blank"> <img width="72%"
                                                    height="72%"
        ...
        <script>
            $(document).ready(function() {
                ...
                if (navigator.userAgent.indexOf("UBrowser") >= 0 || navigator.userAgent.indexOf("UCBrowser") >= 0) {
                    ...
                    alert(
                        'Oops ! Its Look Like you are using a UCBrowser.We Blocked the access in it kindly use another browser like chrome.'
                        );
...
<?php /**PATH C:\xampp\htdocs\halkut.oxs\resources\views/layouts/theme.blade.php ENDPATH**/ ?>