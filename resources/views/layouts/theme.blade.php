...
<head>
    ...
    <link href="{{ url('fonts/flaticon/font/flaticon.css') }}" rel="stylesheet" type="text/css" />
    <!-- flaticon css -->
        ...
        <div class="loading">
            <div class="logo">
                @if ($configs->preloader_img != null)
                    <img src="{{ url('images/' . $configs->preloader_img) }}" class="img-responsive"
                        alt="{{ $w_title }}">
                @else
                    <img src="{{ url('images/logo/' . $configs->logo) }}" class="img-responsive"
                        alt="{{ $w_title }}">
                @endif
            </div>
                    ...
                    <div class="nav-logo">
                        <div class="nav-logo">
                            @if ($catlog == 0 && $configs->remove_landing_page == 1)
                                <a href="#" title="{{ $w_title }}"><img
                                        src="{{ url('images/logo/' . $logo) }}" class="img-responsive"
                                        alt="{{ $w_title }}"></a>
                            @else
                                <a href="{{ url('/') }}" title="{{ $w_title }}"><img
                                        src="{{ url('images/logo/' . $logo) }}" class="img-responsive"
                                        alt="{{ $w_title }}"></a>
                            @endif
                        </div>
                                ...
                                @if (Auth::user()->kids_mode_active == 0)
                                    @if (isset($menuh) && count($menuh) > 0)
                                        @foreach ($menuh as $menus)
                                            @if ($auth && getSubscription()->getData()->subscribed == true)
                                                <li>
                                                    <a class="{{ Nav::hasSegment($menus->slug) }}"
                                                        href="{{ url('/', $menus->slug) }}"
                                                        title="{{ $menus->name }}">
                                                        {{ $menus->name }}
                                                    </a>
                                    ...
                                    @if (isset($custom_page) && count($custom_page) > 0)
                                        @foreach ($custom_page as $custom)
                                            @if (isset($custom))
                                                <li>
                                                    <a class="{{ Nav::hasSegment($custom->slug) }}"
                                                        href="{{ url('/page', $custom->slug) }}"
                                                        title="{{ $custom->title }}">
                                                        {{ $custom->title }}
                                                    </a>
                                                </li>
                    ...
                    <div class="login-panel-main-block small-screen-block">
                        <ul>
                            ...
                            @auth
                                @if (Auth::user()->kids_mode_active == 1)
                                    <li class="kids-btn">
                                        <a type="button" href="{{ route('get.kids', Auth::user()->id) }}"
                                                    ...
                                                    @foreach (auth()->user()->unreadnotifications as $n)
                                                        <li>
                                                            ...
                                                            <div id="notification_id"
                                                                ...
                                                                <p class="notification-title"><b> {{ $n->title }}</b>
                                                                </p>
                                                                <p class="notification-data"> {{ $n->data['data'] }}
                                                                    &nbsp;
                                                                    @if (isset($tv))
                                                                        <a type="button"
                                                                            href="{{ url('show/detail', $season->season_slug) }}"
                                                                    ...
                                                                    @if (isset($moviename))
                                                                        <a type="button"
                                                                            href="{{ url('movie/detail', $movieslug) }}"
                                                                            class="notification-button">
                                                                            <b> "{{ $moviename }}"</b>
                                                                        </a>
                                                                    @endif
                                                            ...
                                                            <ul>
                                                                @foreach ($lang as $langitem)
                                                                    <li>
                                                                        ...
                                                                        <a
                                                                            href="{{ route('languageSwitch', $langitem->local) }}">
                                                                            {{ $langitem->name }}
                                                                        </a>
                                                                    </li>
                                                                @endforeach
                                                        ...
                                                        <ul>
                                                            @foreach ($currencies as $currency)
                                                                <li>
                                                                    ...
                                                                    <a
                                                                        href="{{ route('currencySwitch', $currency->code) }}">
                                                                        {{ $currency->code }}
                                                                    </a>
                                                                </li>
                                                            @endforeach
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-7 col-md-6 col-sm-6">
                                                                <div class="admin-wallet-block">
                                                                    <ul>
                                                                        <li><img src="{{ url('/images/walletnew.png') }}"
                                                                                class="img-fluid" alt="">
                                                                            <span
                                                                                class="wallet-title">{{ __('Wallet Balance') }}</span>
                                                                        </li>
                                                                        <li>
                                                                            <span>
                                                            ...
                                                            <div class="col-lg-5 col-md-6 col-sm-6">
                                                                <div class="admin-money-block text-right">
                                                                    <a href="{{ route('user.wallet.show') }}">
                                                                        <ul>
                                                                            <li><img src="{{ url('/images/money.png') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="scroll-down">
                                                        <ul class="admin-list">
                                                            @if ($auth->is_admin == 1)
                                                                <li><a href="{{ url('admin') }}" target="_blank"><img
                                                                            src="{{ url('images/user_dropdown/globe.png') }}"
                                                                            class="img-fluid"
                                                                            alt="">{{ auth()->user()->getRoleNames()[0] }}
                                                                        {{ __('Dashboard') }}</a></li>
                                                            @endif
                                                            @if ($auth->is_assistant == 1)
                                                                <li>
                                                                    <a href="{{ url('admin') }}" target="_blank"><img
                                                                            src="{{ url('images/user_dropdown/globe.png') }}"
                                                                            class="img-fluid" alt="">
                                                                        {{ __('Producer Dashboard') }}</a>
                                                                </li>
                                                            @endif
                                                            <li><a href="{{ url('account') }}"><img
                                                                        src="{{ url('images/user_dropdown/pie-chart.png') }}"
                                                                        class="img-fluid"
                                                                        alt="">{{ __('Dashboard') }}</a></li>
                                                            @if (Module::find('Producer') && Module::find('Producer')->isEnabled())
                                                                @if ($auth->is_admin != 1)
                                                                    @if ($button->producer_approval == 1 && $auth->producer_status == 0)
                                                                        <li><a href="" data-toggle="modal"
                                                                                data-target="#myModalproducer">{{ __('Become An Producer') }}</a>
                                                                        </li>
                                                                    @else
                                                                        <li><a
                                                                                href="{{ url('producer/subscription') }}">{{ __('Producer Subscription Plans') }}</a>
                                                                        </li>
                                                                    @endif
                                                                @endif
                                                            @endif
                                                            @if (getSubscription()->getData()->subscribed == true)
                                                                <li><a href="{{ route('protectedvideo') }}"><img
                                                                            src="{{ url('images/user_dropdown/shield.png') }}"
                                                                            class="img-fluid"
                                                                            alt="">{{ __('Protected Content') }}</a>
                                                                </li>
                                                            @else
                                                                <li><a
                                                                        href="{{ url('account/purchaseplan') }}">{{ __('Subscribe') }}</a>
                                                                </li>
                                                            @endif
                                                            @if (Module::find('Ebook') && Module::find('Ebook')->isEnabled())
                                                                @if ($auth && getSubscription()->getData()->subscribed == true)
                                                                    <li><a href="{{ url('account/ebook') }}"><img
                                                                                src="{{ url('images/user_dropdown/blog.png') }}"
                                                                                class="img-fluid"
                                                                                alt="">{{ __('Ebooks') }}</a>
                                                                    </li>
                                                                @endif
                                                            ...
                                                            @if (isset($button) && $button->movie_request == 1)
                                                                <li><a href="" data-toggle="modal"
                                                                        data-target="#myModalmovierequest">{{ __('Request a Movie') }}</a>
                                                                </li>
                                                            @endif
                                                            @if ($auth && getSubscription()->getData()->subscribed == true && $configs->blog == 1)
                                                                <li><a href="{{ url('account/blog') }}"><img
                                                                            src="{{ url('images/user_dropdown/blog.png') }}"
                                                                            class="img-fluid"
                                                                            alt="">{{ __('Blog') }}</a></li>
                                                            @endif
                                                            <li><a href="{{ url('faq') }}"><img
                                                                        src="{{ url('images/user_dropdown/help.png') }}"
                                                                        class="img-fluid"
                                                                        alt="">{{ __('Faq') }}</a></li>
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                      <ul> -->
                                                            ...
                                                            @if ($auth && getSubscription()->getData()->subscribed == true && $mlt_screen == 1)
                                                                <li><a
                                                                        href="{{ url('/manageprofile/mus/' . Auth::user()->id) }}"><img
                                                                            src="{{ url('images/user_dropdown/user-profile.png') }}"
                                                                            class="img-fluid"
                                                                            alt="">{{ __('Manage Profile') }}</a>
                                                                </li>
                                                            @endif
                                                            @php
                                                            ...
                                                            @if (!is_null($donation) && !is_null($donation_link) && $donation == 1)
                                                                <li><a target="_blank" href="{{ $donation_link }}"><img
                                                                            src="{{ url('images/user_dropdown/donation.png') }}"
                                                                            class="img-fluid"
                                                                            alt="">{{ __('Donation') }}</a></li>
                                                            @endif

                                                            @if (isset($button) && $button->two_factor == 1)
                                                                <li><a
                                                                        href="{{ route('2fa.get') }}">{{ __('2Factor Authentication') }}</a>
                                                                </li>
                                                            @endif
                                                            @php
                                                                $nav = App\Menu::orderBy('position', 'ASC')->get();
                                                            @endphp
                                                            <li><a href="{{ route('watchhistory') }}"><img
                                                                        src="{{ url('images/user_dropdown/history.png') }}"
                                                                        class="img-fluid"
                                                                        alt="">{{ __('Watch History') }} </a>
                                                            </li>
                                                            <li><a href="{{ route('hidden.videos') }}"><img
                                                                        src="{{ url('images/user_dropdown/hide.png') }}"
                                                                        class="img-fluid"
                                                                        alt="">{{ __('Hidden Videos') }} </a>
                                                            </li>
                                                            <li><a href="{{ url('account/watchlist', $nav[0]->slug) }}"><img
                                                                        src="{{ url('images/user_dropdown/bookmark.png') }}"
                                                                        class="img-fluid"
                                                                        alt="">{{ __('Watch list') }} </a> </li>
                                                            <li>
                                                                <a href="{{ route('custom.logout') }}"><img
                                                                        src="{{ url('images/user_dropdown/log-out.png') }}"
                                                                        class="img-fluid" alt="">
                                                                    {{ __('Sign Out') }}
                                                                </a>
                                                            </li>
                    ...
                    @auth
                        @if (Auth::user()->producer == 0)
                            ...
                            <div class="modal-body">
                                <form id="demo-form2" method="POST" action="{{ url('request-producer') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fname">{{ __('User Name') }} : <sup
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="number">{{ __('Age') }} : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="number" value="{{ $auth->age }}" class="form-control"
                                                    name="age" id="title" placeholder="{{ 'Enter Age' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="file">{{ __('Upload Your ID Proof') }} : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="file" class="form-control" name="govtid" id="file"
                                                    value="{{ $auth->govtid }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="file">{{ __('Upload Your Image') }} : <sup
                                                        class="redstar">*</sup></label>
                                                <input type="file" class="form-control" name="image" id="file"
                                                    value="{{ $auth->image }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="textarea">{{ __('Description') }} : <sup
                                                        class="redstar">*</sup></label>
                        ...
                        @else
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">
                                    {{ __('You Already sent a request for Producer') }}</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <form id="demo-form2" method="POST" action="{{ url('cancel-request-producer') }}"
                                    data-parsley-validate class="form-horizontal form-label-left"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="box-footer">
                                        <button type="submit"
                                            class="btn btn-lg col-md-3 btn-danger">{{ __('Cancel Request') }}</button>
                                    </div>
                                </form>
                            </div>
                        @endif
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    @auth
                        ...
                        <div class="modal-body">
                            <form id="demo-form2" method="POST" action="{{ url('request-movie') }}"
                                data-parsley-validate class="form-horizontal form-label-left"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $auth->id }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">{{ __('Movie Request Name') }} : <sup
                                                class="redstar">*</sup></label>
                                        <input type="text" class="form-control" name="mr_name" id="title"
                                            placeholder="  {{ __('Enter Your Requet Movie Name') }}" required>
                                    </div>
                                </div>
                        </div>
                                ...
                                @if (isset($menuh) && count($menuh) > 0)
                                    @foreach ($menuh as $menus)
                                        @if ($auth && getSubscription()->getData()->subscribed == true)
                                            <li>
                                                <a class="{{ Nav::hasSegment($menus->slug) }}"
                                                    href="{{ url('/', $menus->slug) }}" title="{{ $menus->name }}">
                                                    {{ $menus->name }}
                                                </a>
                                            </li>
                                        @else
                                ...
                                @if (isset($custom_page) && count($custom_page) > 0)
                                    ...
                                    @if ($button->kids_mode == 1)
                                        @if (Auth::user() && $auth != null && getSubscription()->getData()->subscribed == true)
                                            <li style="width:13%;padding: 0px">
                                                <a href="{{ route('get.kids', Auth::user()->id) }}"
                                                    style="background-image: url({{ asset('images/kids.png') }});background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
                                            </li>
                                        @endif
                                    @endif
                                @else
                                ...
                                <div id="ex4" class="dropdown prime-dropdown">
                                    ...
                                    <span class="p1 fa-stack fa-2x has-badge dropdown-toggle" type="button"
                                        ...
                                        <i class="p3 flaticon-bell fa-stack-1x xfa-inverse"
                                            data-count="4b">{{ __('Notification') }}</i>
                                        <div class="notify-count count" count="0">
                                    ...
                                    <ul class="dropdown-menu prime-dropdown-menu">
                                        ...
                                        @foreach (auth()->user()->unreadnotifications as $n)
                                            <li>
                                                ...
                                                @endphp
                                                <div id="notification_id" onclick="readed('{{ $n->id }}')"
                                                    class="card notification-id">
                        ...
                        <li class="sign-in-block">
                            <div class="dropdown prime-dropdown">
                                ...
                                <ul class="dropdown-menu prime-dropdown-menu">
                                    @if ($auth->is_admin == 1)
                                        <li><a href="{{ url('admin') }}"
                                                target="_blank">{{ __('Admin Dashboard') }}</a></li>
                                    @endif
                                    @if ($auth->is_assistant == 1)
                                        <li>
                                    ...
                                    @if (getSubscription()->getData()->subscribed == true)
                                        <li><a href="{{ route('protectedvideo') }}">{{ __('Protected Content') }}</a>
                                        </li>
                                    @else
                                        <li><a href="{{ url('account/purchaseplan') }}">{{ __('Subscribe') }}</a></li>
                                    @endif
                                    ...
                                    @endphp
                                    @if (!is_null($donation) && !is_null($donation_link) && $donation == 1)
                                        <li><a target="_blank" href="{{ $donation_link }}">{{ __('Donation') }}</a>
                                        </li>
                                    @endif
                                    <li><a href="{{ url('faq') }}">{{ __('FAQa') }}</a></li>
                                    @if (isset($button) && $button->two_factor == 1)
                                        <li><a href="{{ route('2fa.get') }}">{{ __('2Factor Authentication') }}</a>
                                        </li>
                                    @endif
                                    @php
                                        $nav = App\Menu::orderBy('position', 'ASC')->get();
                                    ...
                                    <li><a href="{{ url('account/watchlist', $nav[0]->slug) }}"> {{ __('Watch list') }}
                                        </a> </li>
    ...
    @if ($prime_footer == 1)
        <footer id="prime-footer" class="prime-footer-main-block">
            <div class="container-fluid">
                ...
                <div class="logo">
                    <img src="{{ url('images/logo/' . $logo) }}" class="img-responsive"
                        alt="{{ $w_title }}">
                </div>
                ...
                <div class="text-center">
                    ...
                    <div class="footer-widgets social-widgets social-btns">
                        <ul>
                            @if (isset($si->url1))
                                <li><a href="{{ $si->url1 }}" target="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                </li>
                            @endif
                            @if (isset($si->url2))
                                <li><a href="{{ $si->url2 }}" target="_blank"><i class="fa fa-twitter"></i></a>
                                </li>
                            @endif
                            @if (isset($si->url3))
                                <li><a href="{{ $si->url3 }}" target="_blank"><i class="fa fa-youtube"></i></a>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="footer-widgets social-widgets social-btns">
                        <ul>
                            @if ($isappstore == 1 && $isappstore != null)
                                <li> <a href="{{ $appstore }}" target="_blank"> <img width="12%"
                                            height="12%" src="{{ url('images/app_store_download.png') }}"></a>
                                </li>
                            @endif
                            @if ($isplay == 1 && $isplay != null)
                                <li>
                                    <a href="{{ $playstore }}" target="_blank"> <img width="12%"
                                            height="12%" src="{{ url('images/google_play_download.png') }}"></a>
                                </li>
                            @endif
                        </ul>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="footer-links-block">
                                            ...
                                            <ul>
                                                ...
                                                @if (isset($configs->terms_condition) && $configs->terms_condition != null)
                                                    <li><a
                                                            href="{{ url('terms_condition') }}">{{ __('Terms and Condition') }}</a>
                                                    </li>
                                                @endif
                                                @if (isset($configs->privacy_pol) && $configs->privacy_pol != null)
                                                    <li><a
                                                            href="{{ url('privacy_policy') }}">{{ __('Privacy Policy') }}</a>
                                                    </li>
                                                @endif
                                                @if (isset($configs->refund_pol) && $configs->refund_pol != null)
                                                    <li><a
                                                            href="{{ url('refund_policy') }}">{{ __('Refund Policy') }}</a>
                                                    </li>
                                                @endif
                                                <li><a href="{{ url('faq') }}">{{ __('Help') }}</a></li>
                                                <li><a href="{{ url('contactus') }}">{{ __('Contact Us') }}</a>
                                                </li>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="footer-widgets social-widgets social-btns">
                                <ul>
                                    ...
                                    @endif
                                    @if (isset($si->url2))
                                        <li><a href="{{ $si->url2 }}" target="_blank"><i
                                                    class="fa fa-twitter"></i></a>
                                        </li>
                                    @endif
                                    @if (isset($si->url3))
                                        <li><a href="{{ $si->url3 }}" target="_blank"><i
                                    ...
                                    @if ($isappstore == 1 && $isappstore != null)
                                        <li> <a href="{{ $appstore }}" target="_blank"> <img width="72%"
                                                    height="72%"
                                                    src="{{ url('images/app_store_download.png') }}"></a></li>
                                    @endif
                                    @if ($isplay == 1 && $isplay != null)
                                        <li>
                                            <a href="{{ $playstore }}" target="_blank"> <img width="72%"
                                                    height="72%"
